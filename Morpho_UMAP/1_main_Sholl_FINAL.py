...
##############################################  SOMA CELULAR ##################################################
                    ...
                    for images in os.listdir(Cells_thresh_path):
                        if images.endswith(".tif"):
                            ...
                            eroded = cv2.erode(image, kernel, iterations=6)
                            ...
                            frame_thickness = 10  # Adjust this value according to the desired frame thickness
...
################################################# GEOMETRIA ###################################################
                    ...
                    # Assuming 'df_polygon' and 'df_polygon2' are DataFrames
...
###############################################################################################################
###############################################################################################################
################################################# CONTANDO RAMIFICACIONES #####################################
                 
                    
                    print ("...")
                    print ("...")
                    print("Generating INITIAL POINTS and new Skeletonize process...")
                    print ("...")
                    print ("...")
                    ...
                    # Calculate 'ratio_branches' with the updated 'Initial_Points' column
...
################################################# DATAFRAME GENERAL #####################################
                    ...
                    # Creating the 'ID' column by concatenating values from columns and 'Cell'
