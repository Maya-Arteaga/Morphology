...
# -*- coding: utf-8 -*-
"""
Created on Sat Oct 21 20:41:53 2023
...
def draw_circle(event, x, y, flags, param):
    ...
    if event == cv2.EVENT_LBUTTONDOWN:
        ...
        if value == 0:
            cv2.circle(binary_image, (x, y), 4, 255, -1)  # Convert background to foreground
        else:
            cv2.circle(binary_image, (x, y), 4, 0, -1)  # Convert foreground to background
