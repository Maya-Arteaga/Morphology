...
svc = SVC(kernel="linear", decision_function_shape='ovo')  # 'ovr' stands for One-vs-Rest
...
plt.ylabel('True')
plt.savefig(Plot_path + "Confusion_Matrix_SFE_RE:linear_Hypertunning.png", dpi=800, bbox_inches="tight")
plt.tight_layout()
plt.show()
